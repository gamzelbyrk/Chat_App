...
import com.example.bitirmeprojesiapp.databinding.ActivitySettingsBinding;
...
public class SettingsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.saveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!binding.etStatus.getText().toString().equals("") && !binding.txtUsername.getText().toString().equals("")){
                    ...
                    Toast.makeText(SettingsActivity.this, "Lütfen Kullanıcı Bilgilerini doldurunuz.", Toast.LENGTH_SHORT).show();
                }
        ...
        binding.textView2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(SettingsActivity.this, "Gizlilik Politikasına tıklandı.", Toast.LENGTH_SHORT).show();
            }
        });
